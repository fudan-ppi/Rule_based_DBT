...
#define TB_JMP_RESET_OFFSET_INVALID 0xffff /* indicates no jump generated */
    ...
    uintptr_t jmp_dest[2];
	 ...
	 void *guest_instr;                  /* guest instruction structure */

    int next_cc;

    #ifdef PROFILE_RULE_TRANSLATION
    uint32_t num_rules_hit;  /* number of rules hit in this basic block */
    uint32_t num_insts_match; /* number of instructions in this basic block 
                                 that can match a rule */
    #endif

    #ifdef PROFILE_RULE_TRANSLATION_HOST
    uint32_t num_host_insn;  /* number of host instructions generated for this basic block */
    uint32_t num_host_rule_insn; /*number of host instructions generated by rules*/
    #endif
