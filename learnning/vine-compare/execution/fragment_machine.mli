...
class virtual fragment_machine : object
  ...
  method virtual get_symbolic_mem :
    Vine.exp -> Vine.typ -> Vine.exp
...
sig
  class frag_machine : object
    ...
    method symbolic_word_reg : register_name -> Vine.exp
    method symbolic_long_reg : register_name -> Vine.exp
    method symbolic_word_var : Vine.var -> Vine.exp
    ...
    method set_mem_symbolic:
      (register_name * string * int) -> string -> Vine.typ -> Vine.stmt
    method get_symbolic_mem:
      Vine.exp -> Vine.typ -> Vine.exp

    method get_reg_exp : register_name -> Vine.exp

    method generate_fresh_var : string -> Vine.typ -> Vine.var
    method generate_exp_with_fresh_symbolic : string -> Vine.exp
    method generate_initialized_var : string -> Vine.typ -> Vine.var
    method declare_initialized_var : Vine.var -> string -> unit

    method set_word_reg_constant : register_name -> int -> unit
