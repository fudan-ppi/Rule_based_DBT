...
sig
  ...
  class sym_region_frag_machine : Decision_tree.decision_tree -> object
    ...
    method symbolic_word_reg : Fragment_machine.register_name -> Vine.exp
    method symbolic_long_reg : Fragment_machine.register_name -> Vine.exp
    ...
    method set_mem_symbolic:
      (Fragment_machine.register_name * string * int) -> string -> Vine.typ -> Vine.stmt
    method get_symbolic_mem:
      Vine.exp -> Vine.typ -> Vine.exp
    method get_reg_exp : Fragment_machine.register_name -> Vine.exp
    ...
    method set_word_reg_constant : Fragment_machine.register_name -> int -> unit
