...
static const ARMOpcode opc_set[] = {
    ...
    [ARM_OPC_MOVS]  = ARM_OPC_MOVS,
    [ARM_OPC_MVN]   = ARM_OPC_MVN,
    [ARM_OPC_MVNS]  = ARM_OPC_MVNS,
    ...
    [ARM_OPC_BIC]   = ARM_OPC_BIC,
    [ARM_OPC_BICS]  = ARM_OPC_BICS,
    [ARM_OPC_LSL]   = ARM_OPC_LSL,
    [ARM_OPC_LSR]   = ARM_OPC_LSR,
    [ARM_OPC_RRX]   = ARM_OPC_RRX,
    [ARM_OPC_LSRS]  = ARM_OPC_LSRS,
    [ARM_OPC_ASR]   = ARM_OPC_ASR,
    [ARM_OPC_ADD]   = ARM_OPC_OP1,
    [ARM_OPC_ADC]   = ARM_OPC_ADC,
    [ARM_OPC_SUB]   = ARM_OPC_SUB,
    [ARM_OPC_SBC]   = ARM_OPC_SBC,
    [ARM_OPC_RSC]   = ARM_OPC_RSC,
    [ARM_OPC_ADDS]  = ARM_OPC_OP5,
    [ARM_OPC_ADCS]  = ARM_OPC_OP5,
    [ARM_OPC_SUBS]  = ARM_OPC_SUBS,
    [ARM_OPC_SBCS]  = ARM_OPC_SBCS,
    [ARM_OPC_RSCS]  = ARM_OPC_RSCS,
    [ARM_OPC_MUL]   = ARM_OPC_OP1,
    [ARM_OPC_UMULL] = ARM_OPC_UMULL,
    [ARM_OPC_UMLAL] = ARM_OPC_UMLAL,
    [ARM_OPC_SMULL] = ARM_OPC_SMULL,
    [ARM_OPC_SMLAL] = ARM_OPC_SMLAL,
    [ARM_OPC_MLA]   = ARM_OPC_OP1,
    [ARM_OPC_RSB]   = ARM_OPC_RSB,
    [ARM_OPC_RSBS]  = ARM_OPC_RSBS,
    [ARM_OPC_CLZ]   = ARM_OPC_CLZ,
    [ARM_OPC_TST]   = ARM_OPC_TST,
    [ARM_OPC_TEQ]   = ARM_OPC_TEQ,
    [ARM_OPC_CMP]   = ARM_OPC_CMP,
    [ARM_OPC_CMN]   = ARM_OPC_CMN,
    [ARM_OPC_B]     = ARM_OPC_B,
    [ARM_OPC_BL]    = ARM_OPC_BL,
    [ARM_OPC_BX]    = ARM_OPC_BX,
    [ARM_OPC_PUSH]  = ARM_OPC_PUSH,
    [ARM_OPC_POP]   = ARM_OPC_POP,
