...
static void assemble_imull(TCGContext *s, X86Instruction *instr)
{
    X86Operand *opd0 = &instr->opd[0];
    X86Operand *opd1 = &instr->opd[1];
    TCGRegSet allocated_regs, desired_regs;
...
static void assemble_push(TCGContext *s, X86Instruction *instr)
{
    X86Operand *opd0 = &instr->opd[0];
    TCGRegSet allocated_regs, desired_regs;
    int num_reg = 0;
...
static void assemble_pop(TCGContext *s, X86Instruction *instr)
{
    X86Operand *opd0 = &instr->opd[0];
    TCGRegSet allocated_regs, desired_regs;
    int cur_offset = 0;
                              ...
                              uint32_t *reg_liveness, RuleRecord *rrule)
{
    switch (instr->opc) {
        ...
        case X86_OPC_JMP:
            ...
            break;
        case X86_OPC_PUSH:
            assemble_push(s, instr);
            break;
        case X86_OPC_POP:
            assemble_pop(s, instr);
            break;
